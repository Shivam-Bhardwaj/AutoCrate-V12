...
if __name__ == "__main__":
    # Check for modern GUI preference or launch interface selector
    try:
        from autocrate_main import main as launch_main_app
        launch_main_app()
    except ImportError:
        # Fallback to legacy interface if modern GUI not available
        print("Modern GUI not available, launching legacy interface...")
        root = tk.Tk()
        app = CrateApp(root)
        root.mainloop()
