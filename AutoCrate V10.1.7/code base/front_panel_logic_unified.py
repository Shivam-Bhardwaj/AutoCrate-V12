...
def calculate_required_panel_height_for_splice_coverage(
    ...
    """
    Calculate the height adjustment needed for splice coverage.
    """
    
    if not horizontal_splice_positions:
        return 0.0
    
    # Check if first splice is covered by bottom edge cleat
    ...
    required_adjustment = first_splice_position - bottom_edge_cleat_coverage
