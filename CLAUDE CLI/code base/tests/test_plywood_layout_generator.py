...
@patch("plywood_layout_generator.argparse.ArgumentParser.parse_args")
...
def test_main_manual_dimensions_missing_values(mock_args):
    ...
    with patch("plywood_layout_generator.argparse.ArgumentParser.error", side_effect=SystemExit(2)):
